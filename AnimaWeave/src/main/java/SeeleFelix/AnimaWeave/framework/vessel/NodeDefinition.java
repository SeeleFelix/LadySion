...
/**
 * 节点定义
 * 定义节点的输入输出端口规格（不包含执行逻辑）
 * 
 * 在新架构中：
 * - NodeDefinition 只定义节点的"接口规格"（输入输出端口）
 * - NodeInstance 负责实际的执行逻辑
 */
public record NodeDefinition(
     ...
     * 创建带描述的节点定义
     */
    public static NodeDefinition withDescription(String nodeType, String displayName, String description,
                                               List<PortDefinition> inputPorts,
                                               List<PortDefinition> outputPorts) {
