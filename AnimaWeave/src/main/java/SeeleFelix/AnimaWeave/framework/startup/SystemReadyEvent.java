...
/**
 * 系统就绪事件
 * 当所有vessel都加载完成，系统准备好执行图时发出
 */
@Getter
@ToString(callSuper = true, of = {"loadedVesselsCount", "startupTime"})
@EqualsAndHashCode(callSuper = false, of = {"loadedVessels", "startupTime"})
public final class SystemReadyEvent extends AnimaWeaveEvent {
    
    private final Set<String> loadedVessels;
    private final long startupTime;
    
    public SystemReadyEvent(Object source, String sourceIdentifier,
                           Set<String> loadedVessels, long startupTime) {
     ...
     * 便捷的静态工厂方法
     */
    public static SystemReadyEvent of(Object source, String sourceIdentifier,
                                    Set<String> loadedVessels, long startupTime) {
