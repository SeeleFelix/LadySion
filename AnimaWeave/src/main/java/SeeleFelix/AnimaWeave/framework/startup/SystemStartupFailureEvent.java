...
/** 系统启动失败事件 当关键vessel加载失败，导致系统无法启动时发出 */
@Getter
@ToString(
    callSuper = true,
    of = {"failedVesselsCount", "reason"})
@EqualsAndHashCode(
    callSuper = false,
    of = {"failedVessels", "reason"})
public final class SystemStartupFailureEvent extends AnimaWeaveEvent {

  private final Set<String> failedVessels;
  private final String reason;

  public SystemStartupFailureEvent(
      Object source, String sourceIdentifier, Set<String> failedVessels, String reason) {
  ...
  /** 便捷的静态工厂方法 */
  public static SystemStartupFailureEvent of(
      Object source, String sourceIdentifier, Set<String> failedVessels, String reason) {
